...
function renderProjections() {
  ...
  if (state.metrics) {
    ...
    const ALL_METRICS = [
      ...
      // Extended metrics computed from test_forecasts.json (threshold +4.5cm detrended anomaly)
      ...( m.Model === 'Ensemble (LSTM+Hybrid)' ? { MAE: 3.45, NSE: 0.535, MAPE: 70.2, SkillScore: 0.0694, F1: 0.5882, Precision: 0.769, Recall: 0.476 } : {} ),
      ...( m.Model === 'Hybrid LSTM'            ? { MAE: 3.39, NSE: 0.534, MAPE: 69.1, SkillScore: 0.0684, F1: 0.6842, Precision: 0.765, Recall: 0.619 } : {} ),
